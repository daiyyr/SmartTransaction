...
using AzureIoTPortal.Web.Models.Account;
using AzureIoTPortal.Web.Views.Shared.Components.TenantChange;

namespace AzureIoTPortal.Web.Controllers
{
    public class AccountController : AzureIoTPortalControllerBase
    {
